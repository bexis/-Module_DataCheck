using BExIS.Modules.DPT_BE.UI.Helpers;
using System;
using Vaiona.Logging;
using Vaiona.Web.Mvc.Modularity;

namespace BExIS.Modules.DPT_BE.UI
{
    public class DPT_BEModule : ModuleBase
    {
        public DPT_BEModule() : base("DPT_BE")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of DPT_BE...");
        }
        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of DPT_BE...");
            try
            {
                base.Install();
                using (DPT_BESeedDataGenerator generator = new DPT_BESeedDataGenerator())
                {
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of DPT_BE...");
